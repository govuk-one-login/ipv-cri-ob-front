declare module '@govuk-one-login/di-ipv-cri-common-express/src/bootstrap/lib/logger' {
  ...
  interface Logger {
    get(name: string): AppLogger
  }
  const logger: Logger
  export default logger
}

declare module '@govuk-one-login/di-ipv-cri-common-express/src/lib/helmet' {
  ...
  const helmetConfig: CommonExpressHelmetConfig
  export default helmetConfig
}

declare module '@govuk-one-login/di-ipv-cri-common-express/src/lib/i18next/handler.js' {
...
declare module '@govuk-one-login/di-ipv-cri-common-express' {
  import type { CommonExpressHelmetConfig } from '../config/helmet'
  import type { OverloadProtectionConfig } from '../config/overload-protection'
  ...
  interface CommonExpress {
    ...
    lib: {
      ...
      i18next: {
        /** sets req.i18n.language via i18next-http-middleware. Required for frontendUiMiddlewareIdentityBypass */
        handler: (options?: {
          cookieDomain?: string
          debug?: boolean
          secure?: boolean
